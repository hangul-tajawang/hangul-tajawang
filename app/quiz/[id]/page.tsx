  ...
  return (
    <div className="w-full py-8 text-on-surface">
      ...
      <div className="flex flex-col items-center">
        {/* 인터랙티브 퀴즈 컴포넌트 */}
        <Suspense fallback={<div className="animate-pulse bg-zinc-100 w-full max-w-2xl mx-auto h-80 rounded-2xl my-12" />}>
          <SpellingQuiz 
            question={data} 
        ...
        <article className="mt-12 w-full max-w-4xl px-6 lg:px-8 animate-in fade-in duration-1000">
            ...
            <div className="prose prose-lg text-zinc-700 max-w-none">
                <dl className="mb-10 space-y-6">
                    <div className="bg-surface-low p-8 rounded-2xl border border-surface-high">
                        <dt className="text-xl font-bold flex items-center gap-2 mb-4 text-zinc-900">
                    ...
                    <div className="bg-surface-lowest p-8 rounded-2xl border border-surface-high">
                        ...
                        <dd className="leading-relaxed space-y-4 font-medium">
                            <p>{data.aeoAnswer}</p>
                            <div className="pt-4 border-t border-surface-high text-sm text-zinc-600">
                ...
                <div className="mt-12 text-center flex flex-col items-center">
                    <p className="text-zinc-600 mb-6 font-medium">머리로만 외우지 말고 손가락으로 직접 쳐서 기억하세요.</p>
                    <Link prefetch={false} 
                        href="/practice/short/healing" 
                        className="inline-flex items-center gap-2 px-8 py-4 bg-zinc-900 text-white font-bold rounded-2xl hover:scale-105 transition-transform"
                    >
                ...
                <section className="mt-16 pt-10 border-t border-surface-high not-prose">
                    <h2 className="text-2xl font-bold mb-6 text-zinc-900">이런 맞춤법도 자주 틀려요</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {relatedQuizzes.map((q) => (
                            ...
                            >
                                <span className="font-bold text-zinc-700 group-hover:text-blue-600 transition-colors line-clamp-1">
                                    {q.aeoQuestion}
                                </span>
                    ...
                    <div className="mt-8 text-center">
                        <Link prefetch={false} href="/quiz" className="text-sm font-bold text-blue-600 hover:underline">
                            맞춤법 문제 전체 보기 →
                        </Link>
                    </div>
                </section>
