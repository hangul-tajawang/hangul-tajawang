      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-zinc-200 dark:border-zinc-800 pt-16 pb-20">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3 text-emerald-600">
            <Target size={28} />
            <h2 className="text-2xl font-black">타자 계단 게임이란?</h2>
          </div>
          <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium break-keep">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3 text-amber-500">
            <Gauge size={28} />
            <h2 className="text-2xl font-black">몇 층까지 올라갈 수 있나요?</h2>
          </div>
          <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium break-keep text-sm">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3 text-yellow-500">
            <Trophy size={28} />
            <h2 className="text-2xl font-black">실시간 층수 랭킹</h2>
          </div>
          <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium break-keep">
