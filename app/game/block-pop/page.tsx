      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-zinc-200 pt-16 pb-20">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3 text-rose-600">
            <Target size={28} />
            <h2 className="text-2xl font-bold">블록 팝핑 게임 소개</h2>
          </div>
          <p className="text-zinc-600 leading-relaxed font-medium">
            <strong className="text-zinc-900">블록 팝핑</strong>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3 text-orange-500">
            <Zap size={28} />
            <h2 className="text-2xl font-bold">특수 블록 기믹</h2>
          </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3 text-yellow-500">
            <Trophy size={28} />
            <h2 className="text-2xl font-bold">실시간 랭킹 시스템</h2>
          </div>
          <p className="text-zinc-600 leading-relaxed font-medium">
