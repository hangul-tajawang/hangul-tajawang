  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-zinc-200 dark:border-zinc-800 pt-16 pb-20">
          <section className="space-y-6">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
              ...
              <strong className="text-zinc-900 dark:text-zinc-100">한글 단어</strong>가 떠 있습니다.
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-3 text-orange-500">
              <Keyboard size={28} />
              <h2 className="text-2xl font-black">플레이 방법과 스킬</h2>
            </div>
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-3 text-emerald-600">
              <Swords size={28} />
              <h2 className="text-2xl font-black">웨이브 서바이벌</h2>
            </div>
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-3 text-yellow-500">
              <Trophy size={28} />
              <h2 className="text-2xl font-black">점수·콤보와 랭킹</h2>
            </div>
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
