...
[타자 레이스](/game/typing-race)는 달팽이, 토끼, 코뿔소, 파랑새와 경주하며 문장을 입력해 결승선을 통과하는 게임입니다. 상대가 눈에 보이는 경쟁 구도라서 혼자 연습할 때보다 확실히 손이 빨라집니다. 코뿔소(500타)를 이기는 날이 오면 [속도 테스트](/test)에서 기록을 재보세요. 꽤 올라 있을 겁니다.
