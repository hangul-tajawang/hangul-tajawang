...
<div style="display: flex; justify-content: center; margin: 2rem 0;">
  <svg width="400" height="200" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="170" cy="140" r="10" fill="#1E293B"/> <!-- 손 -->
    <rect x="185" y="135" width="40" height="10" rx="2" fill="#94A3B8"/> <!-- 키보드 -->
    ...
    <circle cx="340" cy="120" r="10" fill="#1E293B"/> <!-- 손 -->
    <rect x="355" y="115" width="40" height="10" rx="2" fill="#94A3B8"/> <!-- 키보드 -->
...
<div align="center" style="margin-top: 20px;">
  <a href="/practice" style="display: inline-block; background-color: #2563EB; color: white; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 8px;">
    지금 바로 타자 연습하기
  </a>
</div>
`
