...
import { SAJASEONGEO, SAJASEONGEO_GROUPS } from './sajaseongeo-data';
...
export interface JourneyCourse {
  ...
  ui?: 'subway' | 'worldmap' | 'periodic' | 'flags' | 'map' | 'idiom';
  /** 진행 방식 — 기본은 순서 암기(이름→지식 2단계). 'quiz'는 질문(name)→정답(fact) 1단계 */
  flow?: 'quiz';
  /** quiz 질문 접미사 — name 뒤에 붙는다 (예: '의 수도는?') */
  questionSuffix?: string;
  /** 순서 코스의 문제 라벨 (예: '이 사자성어는?') — 그룹 라벨이 있으면 앞에 붙는다. 미지정 시 'N번째 {unit}은?' */
  stationQuestion?: string;
  /** reading(한자 등)을 문제 카드에 크게 보여주고, 목록 표의 '시기' 열 대신 이 이름으로 표시 */
  readingLabel?: string;
  /** 도착 후 지식 문장을 따라 쓸 때 보여줄 안내 (예: '뜻을 그대로 따라 쓰면 다음으로 넘어가요') */
  arrivalGuide?: string;
...
export const JOURNEY_COURSES: JourneyCourse[] = [
  ...
  // ── 세계 수도 (지도형 UI) ──────────────────────────────────────────────
  {
    ...
    description:
      '아시아부터 오세아니아까지 190여 개 나라의 수도를 문제로 풀며 외웁니다. "대한민국의 수도는?" 질문에 초성 힌트를 보고 수도를 타자로 입력하면 지도에서 다음 나라로 넘어갑니다.',
    category: '지리',
    emoji: '🌍',
    ui: 'worldmap',
    flow: 'quiz',
    ...
    lines: [
      {
        ...
        stations: [
          ...
          { id: 'kz', name: '카자흐스탄', fact: '아스타나', group: 'asia', detail: '1997년 알마티에서 아스타나로 수도를 옮겼습니다.' },
          ...
          { id: 'kp', name: '북한', fact: '평양', group: 'asia' },
          { id: 'lk', name: '스리랑카', fact: '스리자야와르데네푸라코테', group: 'asia', aliases: ['코테'], detail: '법률상 수도는 코테, 최대 도시이자 경제 중심지는 콜롬보입니다.' },
          { id: 'bt', name: '부탄', fact: '팀푸', group: 'asia' },
          { id: 'mv', name: '몰디브', fact: '말레', group: 'asia' },
          { id: 'af', name: '아프가니스탄', fact: '카불', group: 'asia' },
          { id: 'iq', name: '이라크', fact: '바그다드', group: 'asia' },
          { id: 'kw', name: '쿠웨이트', fact: '쿠웨이트', group: 'asia', aliases: ['쿠웨이트시티'], detail: '나라 이름과 같은 쿠웨이트(쿠웨이트시티)가 수도입니다.' },
          { id: 'bh', name: '바레인', fact: '마나마', group: 'asia' },
          { id: 'om', name: '오만', fact: '무스카트', group: 'asia' },
          { id: 'ye', name: '예멘', fact: '사나', group: 'asia', detail: '헌법상 수도는 사나이며, 내전 이후 정부는 아덴을 임시 수도로 삼고 있습니다.' },
          { id: 'jo', name: '요르단', fact: '암만', group: 'asia' },
          { id: 'sy', name: '시리아', fact: '다마스쿠스', group: 'asia' },
          { id: 'lb', name: '레바논', fact: '베이루트', group: 'asia' },
          { id: 'cy', name: '키프로스', fact: '니코시아', group: 'asia' },
          { id: 'ge', name: '조지아', fact: '트빌리시', group: 'asia' },
          { id: 'am', name: '아르메니아', fact: '예레반', group: 'asia' },
          { id: 'az', name: '아제르바이잔', fact: '바쿠', group: 'asia' },
          { id: 'tm', name: '투르크메니스탄', fact: '아시가바트', group: 'asia', aliases: ['아슈하바트'] },
          { id: 'kg', name: '키르기스스탄', fact: '비슈케크', group: 'asia' },
          { id: 'tj', name: '타지키스탄', fact: '두샨베', group: 'asia' },
          { id: 'mm', name: '미얀마', fact: '네피도', group: 'asia', detail: '2006년 양곤에서 네피도로 수도를 옮겼습니다.' },
          { id: 'bn', name: '브루나이', fact: '반다르스리브가완', group: 'asia' },
          { id: 'tl', name: '동티모르', fact: '딜리', group: 'asia' },
          // 유럽
          ...
          { id: 'lu', name: '룩셈부르크', fact: '룩셈부르크', group: 'europe', detail: '나라 이름과 수도 이름이 같습니다.' },
          { id: 'li', name: '리히텐슈타인', fact: '파두츠', group: 'europe' },
          { id: 'ad', name: '안도라', fact: '안도라라베야', group: 'europe', aliases: ['안도라라벨라'] },
          { id: 'mc', name: '모나코', fact: '모나코', group: 'europe', detail: '나라 전체가 하나의 도시인 도시국가입니다.' },
          { id: 'sm', name: '산마리노', fact: '산마리노', group: 'europe' },
          { id: 'va', name: '바티칸', fact: '바티칸', group: 'europe', aliases: ['바티칸시티', '바티칸시국'], detail: '세계에서 가장 작은 나라로, 나라 전체가 곧 수도입니다.' },
          { id: 'mt', name: '몰타', fact: '발레타', group: 'europe' },
          { id: 'al', name: '알바니아', fact: '티라나', group: 'europe' },
          { id: 'mk', name: '북마케도니아', fact: '스코페', group: 'europe' },
          { id: 'rs', name: '세르비아', fact: '베오그라드', group: 'europe' },
          { id: 'me', name: '몬테네그로', fact: '포드고리차', group: 'europe' },
          { id: 'ba', name: '보스니아헤르체고비나', fact: '사라예보', group: 'europe' },
          { id: 'hr', name: '크로아티아', fact: '자그레브', group: 'europe' },
          { id: 'si', name: '슬로베니아', fact: '류블랴나', group: 'europe' },
          { id: 'sk', name: '슬로바키아', fact: '브라티슬라바', group: 'europe' },
          { id: 'is', name: '아이슬란드', fact: '레이캬비크', group: 'europe', detail: '세계에서 가장 북쪽에 있는 주권국가의 수도입니다.' },
          { id: 'ee', name: '에스토니아', fact: '탈린', group: 'europe' },
          { id: 'lv', name: '라트비아', fact: '리가', group: 'europe' },
          { id: 'lt', name: '리투아니아', fact: '빌뉴스', group: 'europe' },
          { id: 'by', name: '벨라루스', fact: '민스크', group: 'europe' },
          { id: 'md', name: '몰도바', fact: '키시너우', group: 'europe', aliases: ['키시네프'] },
          { id: 'bg', name: '불가리아', fact: '소피아', group: 'europe' },
          // 아메리카
          { id: 'us', name: '미국', fact: '워싱턴', group: 'americas', aliases: ['워싱턴디시', '워싱턴DC'] },
          ...
          { id: 'bo', name: '볼리비아', fact: '라파스', group: 'americas', aliases: ['수크레'], detail: '정부가 있는 행정 수도는 라파스, 헌법상 수도는 수크레입니다.' },
          { id: 'gt', name: '과테말라', fact: '과테말라시티', group: 'americas', aliases: ['과테말라'] },
          { id: 'bz', name: '벨리즈', fact: '벨모판', group: 'americas' },
          { id: 'sv', name: '엘살바도르', fact: '산살바도르', group: 'americas' },
          { id: 'hn', name: '온두라스', fact: '테구시갈파', group: 'americas' },
          { id: 'ni', name: '니카라과', fact: '마나과', group: 'americas' },
          { id: 'cr', name: '코스타리카', fact: '산호세', group: 'americas' },
          { id: 'pa', name: '파나마', fact: '파나마시티', group: 'americas', aliases: ['파나마'] },
          { id: 'jm', name: '자메이카', fact: '킹스턴', group: 'americas' },
          { id: 'ht', name: '아이티', fact: '포르토프랭스', group: 'americas' },
          { id: 'do', name: '도미니카공화국', fact: '산토도밍고', group: 'americas' },
          { id: 'bs', name: '바하마', fact: '나소', group: 'americas' },
          { id: 'bb', name: '바베이도스', fact: '브리지타운', group: 'americas' },
          { id: 'tt', name: '트리니다드토바고', fact: '포트오브스페인', group: 'americas' },
          { id: 'gd', name: '그레나다', fact: '세인트조지스', group: 'americas' },
          { id: 'lc', name: '세인트루시아', fact: '캐스트리스', group: 'americas' },
          { id: 'vc', name: '세인트빈센트그레나딘', fact: '킹스타운', group: 'americas' },
          { id: 'ag', name: '앤티가바부다', fact: '세인트존스', group: 'americas' },
          { id: 'kn', name: '세인트키츠네비스', fact: '바스테르', group: 'americas' },
          { id: 'dm', name: '도미니카연방', fact: '로조', group: 'americas' },
          { id: 'gy', name: '가이아나', fact: '조지타운', group: 'americas' },
          { id: 'sr', name: '수리남', fact: '파라마리보', group: 'americas' },
          { id: 'ec', name: '에콰도르', fact: '키토', group: 'americas' },
          { id: 'py', name: '파라과이', fact: '아순시온', group: 'americas' },
          // 아프리카
          { id: 'eg', name: '이집트', fact: '카이로', group: 'africa' },
          { id: 'za', name: '남아프리카공화국', fact: '프리토리아', group: 'africa', aliases: ['케이프타운', '블룸폰테인'], detail: '행정 수도 프리토리아, 입법 수도 케이프타운, 사법 수도 블룸폰테인 — 수도가 세 곳입니다.' },
          { id: 'ke', name: '케냐', fact: '나이로비', group: 'africa' },
          { id: 'ng', name: '나이지리아', fact: '아부자', group: 'africa', detail: '1991년 라고스에서 아부자로 수도를 옮겼습니다.' },
          { id: 'ma', name: '모로코', fact: '라바트', group: 'africa' },
          { id: 'et', name: '에티오피아', fact: '아디스아바바', group: 'africa' },
          { id: 'gh', name: '가나', fact: '아크라', group: 'africa' },
          { id: 'tz', name: '탄자니아', fact: '도도마', group: 'africa', detail: '공식 수도는 도도마, 최대 도시는 다르에스살람입니다.' },
          { id: 'dz', name: '알제리', fact: '알제', group: 'africa' },
          { id: 'tn', name: '튀니지', fact: '튀니스', group: 'africa' },
          { id: 'ly', name: '리비아', fact: '트리폴리', group: 'africa' },
          { id: 'mr', name: '모리타니', fact: '누악쇼트', group: 'africa' },
          { id: 'ml', name: '말리', fact: '바마코', group: 'africa' },
          { id: 'ne', name: '니제르', fact: '니아메', group: 'africa' },
          { id: 'td', name: '차드', fact: '은자메나', group: 'africa' },
          { id: 'sd', name: '수단', fact: '하르툼', group: 'africa' },
          { id: 'ss', name: '남수단', fact: '주바', group: 'africa', detail: '2011년 수단에서 독립한 세계에서 가장 젊은 나라 중 하나입니다.' },
          { id: 'er', name: '에리트레아', fact: '아스마라', group: 'africa' },
          { id: 'dj', name: '지부티', fact: '지부티', group: 'africa', detail: '나라 이름과 수도 이름이 같습니다.' },
          { id: 'so', name: '소말리아', fact: '모가디슈', group: 'africa' },
          { id: 'ug', name: '우간다', fact: '캄팔라', group: 'africa' },
          { id: 'rw', name: '르완다', fact: '키갈리', group: 'africa' },
          { id: 'bi', name: '부룬디', fact: '기테가', group: 'africa', detail: '2019년 부줌부라에서 기테가로 정치 수도를 옮겼습니다.' },
          { id: 'mz', name: '모잠비크', fact: '마푸투', group: 'africa' },
          { id: 'mw', name: '말라위', fact: '릴롱궤', group: 'africa' },
          { id: 'zm', name: '잠비아', fact: '루사카', group: 'africa' },
          { id: 'zw', name: '짐바브웨', fact: '하라레', group: 'africa' },
          { id: 'bw', name: '보츠와나', fact: '가보로네', group: 'africa' },
          { id: 'na', name: '나미비아', fact: '빈트후크', group: 'africa' },
          { id: 'ls', name: '레소토', fact: '마세루', group: 'africa' },
          { id: 'sz', name: '에스와티니', fact: '음바바네', group: 'africa', aliases: ['로밤바'], detail: '행정 수도는 음바바네, 왕실과 의회가 있는 곳은 로밤바입니다.' },
          { id: 'mg', name: '마다가스카르', fact: '안타나나리보', group: 'africa' },
          { id: 'mu', name: '모리셔스', fact: '포트루이스', group: 'africa' },
          { id: 'sc', name: '세이셸', fact: '빅토리아', group: 'africa' },
          { id: 'km', name: '코모로', fact: '모로니', group: 'africa' },
          { id: 'cv', name: '카보베르데', fact: '프라이아', group: 'africa' },
          { id: 'sn', name: '세네갈', fact: '다카르', group: 'africa' },
          { id: 'gm', name: '감비아', fact: '반줄', group: 'africa' },
          { id: 'gw', name: '기니비사우', fact: '비사우', group: 'africa' },
          { id: 'gn', name: '기니', fact: '코나크리', group: 'africa' },
          { id: 'sl', name: '시에라리온', fact: '프리타운', group: 'africa' },
          { id: 'lr', name: '라이베리아', fact: '몬로비아', group: 'africa' },
          { id: 'ci', name: '코트디부아르', fact: '야무수크로', group: 'africa', detail: '공식 수도는 야무수크로, 최대 도시이자 경제 중심지는 아비장입니다.' },
          { id: 'tg', name: '토고', fact: '로메', group: 'africa' },
          { id: 'bj', name: '베냉', fact: '포르토노보', group: 'africa', detail: '공식 수도는 포르토노보, 정부 기관이 모인 최대 도시는 코토누입니다.' },
          { id: 'cm', name: '카메룬', fact: '야운데', group: 'africa' },
          { id: 'cf', name: '중앙아프리카공화국', fact: '방기', group: 'africa' },
          { id: 'gq', name: '적도기니', fact: '말라보', group: 'africa' },
          { id: 'ga', name: '가봉', fact: '리브르빌', group: 'africa' },
          { id: 'cg', name: '콩고공화국', fact: '브라자빌', group: 'africa', detail: '콩고강을 사이에 두고 콩고민주공화국의 수도 킨샤사와 마주 보고 있습니다.' },
          { id: 'cd', name: '콩고민주공화국', fact: '킨샤사', group: 'africa' },
          { id: 'ao', name: '앙골라', fact: '루안다', group: 'africa' },
          { id: 'st', name: '상투메프린시페', fact: '상투메', group: 'africa' },
          { id: 'bf', name: '부르키나파소', fact: '와가두구', group: 'africa' },
          // 오세아니아
          { id: 'au', name: '오스트레일리아', fact: '캔버라', group: 'oceania', detail: '시드니와 멜버른의 수도 경쟁 끝에 계획도시 캔버라가 수도가 되었습니다.' },
          { id: 'nz', name: '뉴질랜드', fact: '웰링턴', group: 'oceania' },
          { id: 'fj', name: '피지', fact: '수바', group: 'oceania' },
          { id: 'pg', name: '파푸아뉴기니', fact: '포트모르즈비', group: 'oceania' },
          { id: 'sb', name: '솔로몬제도', fact: '호니아라', group: 'oceania' },
          { id: 'vu', name: '바누아투', fact: '포트빌라', group: 'oceania' },
          { id: 'ws', name: '사모아', fact: '아피아', group: 'oceania' },
          { id: 'to', name: '통가', fact: '누쿠알로파', group: 'oceania' },
          { id: 'tv', name: '투발루', fact: '푸나푸티', group: 'oceania' },
          { id: 'ki', name: '키리바시', fact: '타라와', group: 'oceania', aliases: ['사우스타라와'] },
          { id: 'nr', name: '나우루', fact: '야렌', group: 'oceania', detail: '공식 수도가 없어 정부 청사가 있는 야렌이 사실상 수도 역할을 합니다.' },
          { id: 'mh', name: '마셜제도', fact: '마주로', group: 'oceania' },
          { id: 'fm', name: '미크로네시아', fact: '팔리키르', group: 'oceania' },
          { id: 'pw', name: '팔라우', fact: '응게룰무드', group: 'oceania', detail: '2006년 코로르에서 응게룰무드로 수도를 옮겼습니다.' },
        ],
      },
    ],
  },
  ...
  // ── 사자성어 100 (주제별 10개씩) ─────────────────────────────────────
  {
    id: 'sajaseongeo',
    title: '사자성어 100',
    subtitle: '초성으로 떠올리고 뜻까지 손으로 새기는 사자성어',
    description:
      '시험과 일상에 자주 나오는 사자성어 100개를 주제별로 정복합니다. 한자와 초성을 보고 사자성어를 입력해 도착하면, 공개되는 뜻 한 줄까지 타이핑해야 다음으로 넘어갑니다.',
    unitLabel: '사자성어',
    category: '상식',
    emoji: '📜',
    ui: 'idiom',
    stationQuestion: '이 사자성어는?',
    readingLabel: '한자',
    arrivalGuide: '✍️ 뜻을 그대로 따라 쓰면 다음 사자성어로 넘어가요',
    keywords: ['사자성어', '사자성어 뜻', '사자성어 모음', '사자성어 100', '고사성어', '사자성어 외우기', '한자 성어'],
    groups: SAJASEONGEO_GROUPS,
    lines: [
      {
        id: 'main',
        color: '#b45309',
        stations: SAJASEONGEO,
      },
    ],
  },
];
